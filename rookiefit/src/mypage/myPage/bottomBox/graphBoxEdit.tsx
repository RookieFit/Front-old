...
const GraphBoxEdit = () => {
    ...
    return (
        <div className="bottom-main-box">
            <div>
                <GraphDuobleDate title={'체중 변화 그래프'}
                    nameWeight={'체중 변화량'} weights={[65, 59, 57, 56, 54, 58, 78, 54, 54, 52, 53, 66, 59, 57, 68]}
                    nameHeight={'키 변화량'} heights={[140, 141, 140, 141, 141, 141, 140, 140, 140, 141, 141, 141, 140, 140, 140]}
                />
                <GraphDate title={'칼로리 변화 그래프'} name={'칼로리 변화량'}
                    values={[2502, 2422, 2123, 2215, 2155, 2882, 2923, 2524, 2925, 2654, 3023, 3522, 2023, 2524, 3023]} />
                <button className='toggle-graph-box' onClick={handleToggle}>더 보기v</button>
                {isVisible &&
                    <div >
